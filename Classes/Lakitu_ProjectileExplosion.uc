class Lakitu_ProjectileExplosion extends MM_Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter3
         ...
         StartSizeRange=(X=(Min=30.000000,Max=30.000000),Y=(Min=50.000000,Max=70.000000),Z=(Min=50.000000,Max=70.000000))
     ...
     End Object
     Emitters(0)=SpriteEmitter'tk_MarioMonsters.Lakitu_ProjectileExplosion.SpriteEmitter3'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
         ...
         ColorScale(1)=(RelativeTime=0.450000,Color=(B=255,G=255,R=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255))
         Opacity=0.750000
         MaxParticles=5
         StartLocationShape=PTLS_Polar
         StartLocationPolarRange=(X=(Min=-16384.000000,Max=16384.000000),Y=(Min=-16384.000000,Max=16384.000000),Z=(Min=-20.000000,Max=20.000000))
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(1)=SpriteEmitter'tk_MarioMonsters.Lakitu_ProjectileExplosion.SpriteEmitter4'
